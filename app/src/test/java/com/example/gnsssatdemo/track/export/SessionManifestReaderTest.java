...
public class SessionManifestReaderTest {
    ...
    public void read_parsesSessionJsonAndFileExistence() throws Exception {
        ...
        json.put("selectedTotalAscentMeters", 8.5);
        json.put("selectedAscentSource", "BAROMETER");
        json.put("barometerTotalAscentMeters", 8.5);
        json.put("barometerAscentSampleCount", 12);
        json.put("barometerAscentRejectedSampleCount", 2);
        json.put("gnssTotalAscentMeters", 6.0);
        json.put("gnssAscentSampleCount", 3);
        json.put("gnssAscentRejectedSampleCount", 1);
        ...
        assertEquals(8.5, manifest.selectedTotalAscentMeters, 0.0);
        assertEquals("BAROMETER", manifest.selectedAscentSource);
        assertEquals(8.5, manifest.barometerTotalAscentMeters, 0.0);
        assertEquals(12, manifest.barometerAscentSampleCount);
        assertEquals(2, manifest.barometerAscentRejectedSampleCount);
        assertEquals(6.0, manifest.gnssTotalAscentMeters, 0.0);
        assertEquals(3, manifest.gnssAscentSampleCount);
        assertEquals(1, manifest.gnssAscentRejectedSampleCount);
