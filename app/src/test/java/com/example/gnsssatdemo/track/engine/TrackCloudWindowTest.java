...
public class TrackCloudWindowTest {
    ...
    public void weightedCenterCanBeVirtualCoordinateBetweenRawSamples() {
        ...
        cloud.add(raw(1L, 29.0, 106.0, 2_000_000_000L, 5f), Collections.emptyList());
        TrackCloudWindow.Snapshot result = cloud.add(
                raw(2L, 29.0001, 106.0, 3_000_000_000L, 5f), Collections.emptyList());
    ...
    public void temporalWeightUsesFixMeasurementTimeInsideCloud() {
        ...
        delayedCloud.add(raw(1L, 29.0, 106.0, 2_000_000_000L, 5f), Collections.emptyList());
